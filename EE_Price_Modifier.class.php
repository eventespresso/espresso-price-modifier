	...
	*/	
	private function __construct() {
		...
		if ( is_admin() ) {
			...
			add_filter( 'filter_hook_espresso_parse_admin_question_response_for_price', '_parse_admin_question_response_for_price', 10, 2);
		} else {
	...
	function _generate_form_inputs ( $values, $price_mod = 'N' ) {
		?>
